...
- Honors the requested region as-is (empty falls back to us-east-2). GPT-5.5/5.4 are served in both us-east-1 and us-east-2; GPT-5.4 also in us-west-2 (verified live 2026-06-11 — at v3.1.0's authoring they were us-east-2-only, hence the now-removed remap).
