...
- ✅ Support multiple input formats (issue numbers, URLs, commit SHAs)
- ✅ Handle both short and long commit SHAs
- ✅ Provide rich context (release date, commit count, release URL)
- ✅ Clear error messages for edge cases
- ✅ Works without full git clone (uses `gh` API when possible)
